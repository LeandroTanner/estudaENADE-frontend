    ...
    <body class="site">
      ...
      <?php include '../ARQUIVOS_PADROES/header.php'; ?>
       ...
       <form class="formulario mx-auto">
            ...
            <h2 class="Titulo_Form">CADASTRE UMA PROVA</h2>

            <div class="form-group">
                <label for="titulo">Título Da Prova</label><i class="fa-solid fa-asterisk"></i>
                <input type="title" class="form-control mx-auto form-control-sm" id="titulo" placeholder="Insira seu título" required>
            </div>
            ...
            <div class="text-center">
              ...
              <button type="button" class="btn mb-2"><a href="../CADASTRAR_QUESTOES/Cadastrar_Questoes.php">ADICIONAR QUESTÕES</a></button>
