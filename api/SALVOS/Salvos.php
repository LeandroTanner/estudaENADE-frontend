<html lang="pt-br">
    <head>
        <title>QUESTÕES E PROVAS SALVAS-estudaENADE</title>
        <meta charset="UTF-8">
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
        <link rel="stylesheet" href="../ARQUIVOS_PADROES/CSS_Padrao.css">
        <link rel="stylesheet" href="CSS_Questoes_Provas_Salvas.css">
       ...
       <div class="site-content">
        ...
        <div class="card mx-auto my-3">
            <div class="card-body card-body d-flex align-items-center" style="padding: 1%;">
                <h5 class="card-title mx-auto my-auto">QUESTÕES SALVAS</h5>
            </div>
        </div>
            ...
            <div class="card-body">
              ...
              <p class="card-text">[...]A pandemia ocasionada pelo novo Coronavírus gerou impactos negativos na economia e nos negócios,
                ...
                <div class="text-center">
                    ...
                    <button type="button" class="btn mb-2">Salva<i class="fa-solid fa-bookmark"></i></button>
                </div>
            </div>
        </div>
        ...
        <div class="card mx-auto my-3">
            <div class="card-body card-body d-flex align-items-center" style="padding: 1%;">
                <h5 class="card-title mx-auto my-auto">PROVAS SALVAS</h5>
            </div>
        </div>

        <div class="card conteudo mx-auto">
            <div class="card-body">
              <h5 class="card-title"><i class="fa-solid fa-book"></i> PROVA</h5>
              <h6 class="card-subtitle mb-2 text-muted">Subtitulo caso necessário</h6>
          
              <div class="detalhes-prova">
                <p class="detalhes_Prova">ENADE</p>
                <p class="detalhes_Prova">Ano: 2023</p>
                <p class="detalhes_Prova">Área: Ciência da Computação</p>
              </div>
          
              <div class="text-center">
                <a href="../RESPONDER_PROVAS/Responder_Provas.php" class="btn mb-2" role="button">Responder Prova<i class="fa-regular fa-hand"></i></a>
                <button type="button" class="btn mb-2">Salva<i class="fa-solid fa-bookmark"></i></button>
              </div>
            </div>
          </div>
