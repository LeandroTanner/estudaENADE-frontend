        ...
        <div class="site-content">
            <form class="formulario mx-auto">
                ...
                <div class="form-group">
                  <label for="Email" class="Subtitulo">Endereço de email</label>
                  <input type="email" class="form-control mx-auto" id="Email" aria-describedby="emailHelp" placeholder="Seu email" required>
                  <small id="emailHelp" class="form-text text-muted">Nunca vamos compartilhar seu email, com ninguém.</small>
                </div>
                <div class="form-group">
                  <label for="password" class="Subtitulo">Senha</label>
                  <input type="password" class="form-control mx-auto" id="password" placeholder="Senha" required>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <button type="submit" class="btn btn-primary btn-block btn-sm"><a href="../CADASTRO/Cadastro.php">AINDA NÃO TENHO CONTA</a></button>
                        </div>
                    </div>
                </div>
              </form>
